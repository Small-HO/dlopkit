...
class TextView : AppCompatTextView {
    ...
    private fun initAttributeSet(context: Context, attrs: AttributeSet?) {
        if (attrs != null) {
            ...
            mBackgroundNormal = typedArray.getColor(R.styleable.TextView_background_normal, mBackgroundNormal)
            mCornerRadius = typedArray.getDimensionPixelSize(R.styleable.TextView_corner_radius, mCornerRadius)
            mCornerRadiusTopLeft = typedArray.getDimensionPixelSize(R.styleable.TextView_corner_radius_top_left, mCornerRadiusTopLeft)
            mCornerRadiusTopRight = typedArray.getDimensionPixelSize(R.styleable.TextView_corner_radius_top_right, mCornerRadiusTopRight)
            mCornerRadiusBottomLeft = typedArray.getDimensionPixelSize(R.styleable.TextView_corner_radius_bottom_left, mCornerRadiusBottomLeft)
            mCornerRadiusBottomRight = typedArray.getDimensionPixelSize(R.styleable.TextView_corner_radius_bottom_right, mCornerRadiusBottomRight)
            typedArray.recycle()
        }
    }
